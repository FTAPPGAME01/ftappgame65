...
io.on('connection', (socket) => {
    ...
    socket.on('updateState', (updatedState) => {
        ...
        // Agregar este manejador de eventos
    socket.on('actualizarContadorReinicios', (nuevoContador) => {
        // Retransmitir el nuevo contador a todos los clientes
        io.emit('actualizarContadorReinicios', nuevoContador);
    });
    });
